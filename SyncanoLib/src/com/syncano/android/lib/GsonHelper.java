...
public class GsonHelper {
	...
	public static Gson createGson() {
		...
		gsonBuilder.registerTypeAdapter(Params.class, new ParamsSerializer());
		gsonBuilder.registerTypeAdapter(Date.class, new DateSerializer());
		gsonBuilder.registerTypeAdapter(Date.class, new DateDeserializer());
		return gsonBuilder.excludeFieldsWithoutExposeAnnotation().create();
	}

	private static class ParamsSerializer implements JsonSerializer<Params> {
		public JsonElement serialize(Params params, Type type, JsonSerializationContext jsc) {
			JsonElement json = jsc.serialize(params);

			HashMap<String, String> other = params.getAdditionalParams();
			if (other != null) {
