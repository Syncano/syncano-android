 ...
 * collection_key.
 */
public class ParamsCollectionDeauthorize extends Params {
	/** api client id */
	@Expose
	...
	public ParamsCollectionDeauthorize(String apiClientId, String permission, String projectId, String collectionId,
