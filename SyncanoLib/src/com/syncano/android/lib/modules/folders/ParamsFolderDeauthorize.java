 ...
 * collection_key.
 */
public class ParamsFolderDeauthorize extends Params {
	/** api client id */
	@Expose
	...
	public ParamsFolderDeauthorize(String apiClientId, String permission, String projectId, String collectionId,
