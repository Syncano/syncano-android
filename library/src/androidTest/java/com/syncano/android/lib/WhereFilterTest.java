 ...
 */
public class WhereFilterTest extends ApplicationTestCase<Application> {

    private static final String TAG = WhereFilterTest.class.getSimpleName();

    private CodeBox codeBox;
    private Syncano syncano;

    public WhereFilterTest() {
